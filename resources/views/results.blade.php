        ...
        <div class="row">
                ...
                <div class="row">
                    @foreach($restaurants as $restaurant)
                        <div class="col-lg-4 mb-4">
                            <div class="card">
                               <img src="{{ asset('storage/' . $restaurant->image_url) }}" class="card-img-top" alt="Restaurant Image">
                                <div class="card-body">
            ...
            <div class="col-lg-4">
                ...
                @foreach($closestMatches as $match)
                    <div class="card mb-4">
                        <div class="card-body">
                           <img src="{{ asset('storage/' . $match->image_url) }}" class="card-img-top" alt="Restaurant Image">
